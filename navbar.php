    ...
    <!-- first row -->
        <div class="row1 row1-first"> 
            <div class="row1-80">
                ...
                <p class="">Free shipping over Rs.5000!
                    <a href="newarrivals.php">shop our latest arrivals</a>
                </p>
            </div>
        ...
        <div id="stickingbar">
            ...
            <div class="row1 row1-height row1-second"> 
                <div class="row1-80">
                <a href="index.php"><img class="logo-image" src="img/logo-black.png" alt="Instagram"></a>
                </div>
                ...
                <div class="row1-20">
                        <ul class="nav-list">
                            ...
                            <li class="nav-item">
                                <a href="checkout.php">
                                    ...
                                    <!-- <span name="shoppingcartquantity" class="itemNoBadge">3</span> -->
                                </a>
                            </li>
                            <li class="nav-item">
                                <?php echo $userLink; ?>
                                <a href=""><img src="img/icons/myaccount.png" alt="account"></a>
                                    <ul class="dropdown1">
                                        <!-- <li class="dropdown1-item"><a name="useraccount" href="useraccount-editaccount.php">User Account</a></li>
                                        <li class="dropdown1-item"><a name="adminaccount" href="admin-addUsers.php">Admin Account</a></li> -->
                    ...
                    <!-- <a class="nav-item" href="#"><img src="img/icons/myaccount.png" alt="account"></a>
                       
                    <a href="#"><img src="img/icons/cart.png" alt="shoppingcart"></a> -->
                </div>
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collectiondropdown">
                                    ...
                                    <ul class="dropdown">
                                        <h3>Featured</h3>
                                        <li class="dropdown-item"><a href="footwear.php">Footwear</a></li>
...
<!-- navbar ends -->
    ...
    var navbar = document.getElementById("stickingbar");
