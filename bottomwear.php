...
<head>
    ...
    <title>bottomwear | OXO Threads</title>
    <!-- CSS -->
    ...
    <div class="categories-page">
        <div class="catpage-container">
            ...
            <div class="catpage-row">
                ...
                $sql = "SELECT * FROM `products` WHERE `productcategory` LIKE 'bottomwear' AND `status` = 1 ORDER BY $sortOption";
