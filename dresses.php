...
<head>
    ...
    <title>Dresses | OXO Threads</title>
    <!-- CSS -->
    ...
    <div class="categories-page">
        <div class="catpage-container">
            ...
            <div class="catpage-row">
                ...
                $sortOption = "productname"; // Change this to your default sorting option
                ...
                $sql = "SELECT * FROM `products` WHERE `productcategory` LIKE 'dresses' AND `status` = 1 ORDER BY $sortOption";
