...
<head>
    ...
    <title>Jumpsuits/Rompers | OXO Threads</title>
    <!-- CSS -->
    ...
    <div class="categories-page">
        <div class="catpage-container">
            <div class="header-name">
                ...
                <h3>Jumpsuits/Rompers Collection</h3>
                <img src="img/headingline.png">
            </div>
            ...
            <div class="catpage-row">
                ...
                $sql = "SELECT * FROM `products` WHERE `productcategory` LIKE 'jumpsuits' AND `status` = 1 ORDER BY $sortOption";
